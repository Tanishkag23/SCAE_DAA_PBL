// ==============================================================
//   dfs.c — SCAE Smart City Algorithm Engine
//   Unit 3: Graph Algorithms (Depth First Search)
//
//   SCAE Context:
//   DFS ek maze solver jaisa hai — jab tak rasta block nahi hota,
//   tab tak aage badhte raho. Stack data structure ka use hota hai.
//   Connected components nikaalne aur cycles (road loops) detect
//   karne ke liye DFS best hai. 3-color scheme (unvisited,
//   in-stack/gray, done/black) se cycle detect karna asaan hai!
// ==============================================================

#include "../scae.h"

// ==============================================================
//   FUNCTION 1: dfs_traversal
...
// ==============================================================
//   FUNCTION 2: has_cycle (Helper)
//   Recursive helper for cycle detection using 3-color scheme.
